...
def get_parser():
    ...
    # Model parameters
    parser.add_argument('--checkpoint_path', type=str, default='./results/reaction_model/checkpoints/best-epoch=0000-val_total_loss=0.4343.ckpt', help='Path to the trained model checkpoint')
