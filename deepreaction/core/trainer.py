...
class ReactionTrainer:
    def __init__(
            ...
            cpu_cores: int = 1,  # Added parameter for CPU cores
            **kwargs
    ):
        ...
        self.cpu_cores = cpu_cores  # Store the CPU cores parameter
        self.kwargs = kwargs
    ...
    def fit(self, train_dataset=None, val_dataset=None, test_dataset=None, checkpoint_path=None, mode='continue',
        ...
        trainer_config.update({
            ...
            'devices': 1 if self.gpu and torch.cuda.is_available() else self.cpu_cores,  # Use cpu_cores parameter here
