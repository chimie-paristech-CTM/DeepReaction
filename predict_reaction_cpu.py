...
def get_parser():
    ...
    parser.add_argument('--checkpoint_path', type=str,
                        default='./results/reaction_model/checkpoints/best-epoch=0000-val_total_loss=18.9323.ckpt',
                        help='Path to the trained model checkpoint')

    parser.add_argument('--output_csv', type=str, default='./predictions/predictions.csv', help='Path to save predictions CSV')
